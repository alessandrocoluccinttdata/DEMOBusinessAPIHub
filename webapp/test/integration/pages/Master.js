		...
		onTheMasterPage: {
			...
			actions: {
				...
				iSortTheListOnName: function () {
					return this.iChooseASorter("sortButton", "Sort By <PurchaseOrder>");
				},
				iSortTheListOnUnitNumber: function () {
					return this.iChooseASorter("sortButton", "Sort By <CashDiscount1Days>");
				},

				iFilterTheListOnUnitNumber: function () {
					return this.iChooseASorter("filterButton", "<CashDiscount1Days>", "<100 <DocumentCurrency>");
				},

				iGroupTheList: function () {
					return this.iChooseASorter("groupButton", "<CashDiscount1Days> Group");
				},
				...
				iRememberAnIdOfAnObjectThatsNotInTheList: function () {
					return this.waitFor({
						...
						success: function (oList) {
							var aEntityData = this.getEntitySet("A_PurchaseOrder");
							...
							if (aObjectsNotInTheList.length) {
								sObjectNotInTheListId = aObjectsNotInTheList[0].PurchaseOrder;
							} else {
								// Not enough items all of them are displayed so we take the last one
								sObjectNotInTheListId = aEntityData[aEntityData.length - 1].PurchaseOrder;
							}
							...
							oCurrentItem.bindingPath = "/" + oList.getModel().createKey("A_PurchaseOrder", {
								PurchaseOrder: sObjectNotInTheListId
							});
			...
			assertions: {
				...
				theListShouldBeFilteredOnUnitNumber: function () {
					return this.theListShouldBeFilteredOnFieldUsingComparator("CashDiscount1Days", 100);
				},


				theListShouldBeSortedAscendingOnUnitNumber: function () {
					return this.theListShouldBeSortedAscendingOnField("CashDiscount1Days");
				},
				...
				theListShouldHaveAllEntries: function () {
					return this.waitFor({
						...
						viewName: sViewName,
						success: function (oList) {
							var aAllEntities = this.getEntitySet("A_PurchaseOrder");
					...
					return this.waitFor({
						...
						success: function (oList) {
							...
							return this.waitFor({
								...
								matchers: new PropertyStrictEquals({
									name: "text",
									value: "<A_PurchaseOrder> (" + iExpectedLength + ")"
								}),
								success: function () {
