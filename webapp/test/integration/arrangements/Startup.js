sap.ui.define([
	"sap/ui/test/Opa5",
	"DEMOBusinessAPIHub/DEMOBusinessAPIHub/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("DEMOBusinessAPIHub.DEMOBusinessAPIHub.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "DEMOBusinessAPIHub.DEMOBusinessAPIHub",
					async: true
				},
				hash: oOptions.hash,
